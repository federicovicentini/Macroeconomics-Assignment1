...
Finally we create var results with function boot on the regression, insert R=1000 that are the number of bootstrap replicates and print them 
```{r p4.8}
...
The last step is include the variable "schooling" = "sh" that measure the percentage of the working age population that is in the secondary school. We did this to include the human capital investment in the form of education.
...
As you can see, the value of the variable SCOOL = 0.729 correspond to the value of the book. 
